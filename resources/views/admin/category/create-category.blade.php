...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ $editBoolean ? '': url('admin/category') }}" class="form-sample" id="category" method="post" autocomplete="off" aria-autocomplete="none">
                    ...
                    @method('post')
                    @endif
                    <p class="card-description"> {{$editBoolean ? 'Edit '.$category->name : 'Add'}} Categroy</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex justify-content-center-align-items-center">
                                        <input type="text"  value="{{ $editBoolean ? $category->name : old('name') }}"  name="name" class="form-control @error('name') is-invalid  @enderror" placeholder="Average Life" />
                                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex justify-content-center-align-items-center">
                                        <input readonly type="text" max="5" min="1" value="{{ $editBoolean ? $category->slug : old('slug') }}" class="form-control @error('slug') is-invalid  @enderror" name="slug" placeholder="AFFECTIONATE WITH FAMILY" />
                                        @error('slug')
