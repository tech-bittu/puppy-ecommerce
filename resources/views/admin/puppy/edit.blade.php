...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">{{$editBoolean ? $data['breed'][$data['puppyinfo']->breed_type -1]->name : ''}} Puppy Details </h4>
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-info active" id="simple-tab-0" data-bs-toggle="tab" href="#simple-tabpanel-0" role="tab" aria-controls="simple-tabpanel-0" aria-selected="true" aria-disabled="">Basic Info</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-info " id="simple-tab-1" data-bs-toggle="tab" href="#simple-tabpanel-1" role="tab" aria-controls="simple-tabpanel-1" aria-selected="false">Overview Info </a>
                ...
                <div class="tab-content pt-5" id="tab-content">
                    ...
                    <div class="tab-pane active" id="simple-tabpanel-0" role="tabpanel" aria-labelledby="simple-tab-0">
                        <form action="" class="form-sample" id="collapseBasicInfo" method="post" autocomplete="off" aria-autocomplete="none">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-center-align-items-center">
                                                <textarea id="long_des" name="long_desc" id="" cols="30" rows="10" class="">{{ $editBoolean ? $data['puppyDes'][0]->long_desc : old('long_desc') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="d-flex justify-content-center-align-items-center">
                                                @if($editBoolean)
                                                <img src="{{ asset('puppy-images/og-images/3-t5ba1e9cbba836f77c2a4f271cba816d0.jpg')}}" height="44px" alt="" srcset="">
                                                @endif
