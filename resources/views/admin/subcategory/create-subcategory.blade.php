        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ $editBoolean ? '': url('admin/subcategory') }}" class="form-sample" id="category" method="post" autocomplete="off" aria-autocomplete="none">
                    ...
                    @method('post')
                    @endif
                    <p class="card-description"> {{$editBoolean ? 'Edit '.$subcategory->name : 'Add'}} Subcategory</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex justify-content-center-align-items-center">
                                        <input type="text"  value="{{ $editBoolean ? $subcategory->name : old('name') }}"  name="name" class="form-control @error('name') is-invalid  @enderror" placeholder="Average Life" />
                                        @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex justify-content-center-align-items-center">
                                        <input readonly type="text" max="5" min="1" value="{{ $editBoolean ? $subcategory->slug : old('slug') }}" class="form-control @error('slug') is-invalid  @enderror" name="slug" placeholder="AFFECTIONATE WITH FAMILY" />
                                        @error('slug')
